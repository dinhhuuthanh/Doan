            ...
            <div class="row">
                ...
                <div class="col-md-10 p-0">
                    <div class="content">
                        ...
                        <div class="container">
                            <form id="add-product" action="save-edit/{{$product->id}}" class="pt-3" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}   
                            <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <img src="http://localhost/PHP3_KHUONGTVPH11115/storage/app/public/{{$product->image}}" width="50" height="50" alt="">
                                ...
                                <div class="row">
                                    <div class="container pt-5" style="padding-bottom: 180px">
                                        <button type="submit" class="btn btn-outline-success form-control" style="width: 25%;">Sửa sản phẩm</button>
                                    </div>
                                </div>
                            </form>
                        </div>
