...
<!-- Mirrored from vetra.laborasyon.com/demos/dark-top-menu/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 18 Jul 2021 16:49:40 GMT -->
...
<body class="auth">
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-md-10 offset-md-1">
                                ...
                                <form class="mb-5" action="{{route('login')}}" novalidate method="POST">
                                    @csrf
                                    <div class="mb-3">
    ...
    <!-- Bundle scripts -->
    <script src="{{('admin/libs/bundle.js')}}"></script>
