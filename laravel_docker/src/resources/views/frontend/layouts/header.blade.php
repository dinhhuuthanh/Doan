                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="{{asset('img/mega-menu/fashion.jpg')}}"
                            ...
                            <div class="brand-logo">
                                <a href="index.html"><img src="{{asset('img/icon/logo.png')}}"
                                            ...
                                            <ul class="mega-menu full-mega-menu">
                                                <li>
                                                    <div class="container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <img src="{{asset('img/menu-banner.jpg')}}"
                                ...
                                <div class="icon-nav">
                                    <ul>
                                        <li class="onhover-div mobile-search">
                                            <div><img src="{{asset('img/icon/search.png')}}" onclick="openSearch()"
                                        ...
                                        <li class="onhover-div mobile-setting">
                                            <div><img src="{{asset('img/icon/setting.png')}}"
                                        ...
                                        <li class="onhover-div mobile-cart">
                                            <div><img src="{{asset('img/icon/cart.png')}}"
                                                    class="img-fluid blur-up lazyload" alt=""> <i
                                            ...
                                            <ul class="show-div shopping-cart">
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img alt="" class="me-3"
                                                                src="{{asset('img/fashion/product/1.jpg')}}"></a>
                                                ...
                                                <li>
                                                    <div class="media">
                                                        <a href="#"><img alt="" class="me-3"
                                                                src="{{asset('img/fashion/product/2.jpg')}}"></a>
                                                        <div class="media-body">
                                                            <a href="#">
                                                                <h4>item name</h4>
                                                            </a>
